...
package org.desklink.mobile.plugins.clipboard;
...
/*
    ...
    adb -d shell pm grant org.desklink.mobile android.permission.READ_LOGS;
    ...
    adb -d shell appops set org.desklink.mobile SYSTEM_ALERT_WINDOW allow;
    # Kill the app, new permissions take effect on restart.
    adb -d shell am force-stop org.desklink.mobile;
