/*
 * ContactsPlugin.java - This file is part of DeskLink Mobile's Android App
...
class ContactsPlugin : Plugin() {
    ...
    /**
     * Add custom fields to the vcard to keep track of DeskLink Mobile-specific fields
     *
     *
     ...
     * @return The same VCard as was passed in, but now with DeskLink Mobile-specific fields
     */
