 ...
 */
package org.desklink.mobile.plugins.mousereceiver
...
import org.desklink.mobile.plugins.remotekeyboard.RemoteKeyboardPlugin
...
class MouseReceiverPlugin : Plugin() {
    ...
    override fun onPacketReceived(np: NetworkPacket): Boolean {
        ...
        if (MouseReceiverService.instance == null) {
            Log.w("MouseReceiverPlugin", "Accessibility service is not enabled, dropping remote mouse input")
            return false
        }
